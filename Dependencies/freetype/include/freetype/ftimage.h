...
#define ft_glyph_format_plotter    FT_GLYPH_FORMAT_PLOTTER
   ...
   *   to let client applications drawDynamic themselves the gray pixel spans on
   *   each scan line.
   *
   * @input:
   *   y ::
   ...
   *
   *   count ::
   *     The number of spans to drawDynamic on this scanline.
   *
   *   spans ::
   *     A table of `count` spans to drawDynamic on the scanline.
   *
   *   user ::
...
#define FT_Raster_Span_Func  FT_SpanFunc
   ...
   *     directly drawDynamic or compose over an existing bitmap.  If this bit is
